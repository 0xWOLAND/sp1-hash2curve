...
impl HashToCurve for AffineG2 {
    ...
    fn map_to_curve(u: Fq2) -> Result<Self, substrate_bn::GroupError> {
        ...
        // let z = Fq2::new(
        //     Fq::from_slice(&[
        //         14, 10, 119, 193, 154, 7, 223, 47, 102, 110, 163, 111, 120, 121, 70, 44,
        //         10, 120, 235, 40, 245, 199, 11, 61, 211, 93, 67, 141, 197, 143, 13, 157
        //     ]).unwrap(),
        //     Fq::from_slice(&[0; 32]).unwrap(),
        // );

        // let c1 = Fq2::new(
        //     Fq::from_slice(&[
        //         2, 186, 239, 128, 252, 90, 231, 114, 212, 214, 75, 169, 64, 109, 64, 46,
        //         117, 2, 155, 190, 195, 136, 148, 13, 211, 53, 240, 90, 100, 202, 18, 254
        //     ]).unwrap(),
        //     Fq::from_slice(&[
        //         1, 65, 185, 206, 74, 104, 141, 77, 215, 73, 208, 221, 34, 172, 0, 170,
        //         101, 240, 179, 125, 147, 206, 13, 62, 56, 231, 236, 204, 209, 220, 255, 103
        //     ]).unwrap(),
        // );

        // let c2 = Fq2::new(
        //     Fq::from_slice(&[
        //         17, 44, 235, 88, 163, 148, 224, 125, 40, 240, 209, 35, 132, 132, 9, 24,
        //         198, 132, 63, 180, 57, 85, 95, 167, 180, 97, 164, 68, 137, 118, 247, 213
        //     ]).unwrap(),
        //     Fq::from_slice(&[0; 32]).unwrap(),
        // );
        ...
        // let c3 = Fq2::new(
        //     Fq::from_slice(&[
        //         31, 158, 127, 55, 104, 197, 201, 175, 195, 164, 107, 126, 133, 0, 19, 167,
        //         242, 32, 159, 91, 126, 91, 117, 122, 170, 173, 12, 171, 154, 36, 39, 127
        //     ]).unwrap(),
        //     Fq::from_slice(&[
        //         41, 125, 129, 141, 56, 119, 37, 200, 94, 68, 185, 218, 10, 150, 173, 35,
        //         254, 62, 76, 127, 85, 157, 55, 90, 65, 34, 120, 200, 222, 133, 216, 99
        //     ]).unwrap(),
        // );

        // let c4 = Fq2::new(
        //     Fq::from_slice(&[
        //         28, 158, 244, 245, 240, 82, 139, 130, 180, 109, 30, 237, 85, 196, 144, 0,
        //         115, 168, 34, 13, 64, 235, 22, 246, 99, 205, 199, 150, 180, 155, 58, 50
        //     ]).unwrap(),
        //     Fq::from_slice(&[
        //         46, 183, 86, 181, 40, 166, 57, 23, 67, 237, 217, 228, 253, 241, 87, 122,
        //         100, 235, 37, 233, 248, 180, 99, 143, 154, 235, 80, 91, 22, 0, 254, 19
        //     ]).unwrap(),
        // );
